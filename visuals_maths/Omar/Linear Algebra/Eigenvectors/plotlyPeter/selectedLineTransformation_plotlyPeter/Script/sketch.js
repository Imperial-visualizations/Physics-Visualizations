...
console.log(xEigVector1, yEigVector1);
...
var data = [
    ...
    {
        x: [-lineLength * math.cos(inputTheta) / 1.5, lineLength * math.cos(inputTheta) / 1.5],
        y: [-lineLength * math.sin(inputTheta) / 1.5, lineLength * math.sin(inputTheta)/ 1.5]
    },
